        ...
        <div className="max-w-6xl mx-auto text-center relative z-10 py-32">
          ...
          <div className="grid grid-cols-3 gap-8 max-w-2xl mx-auto mt-24">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">Premium Beats</p>
            </div>
            <div className="text-center border-x border-white/5">
              <p ref={stat2Ref} className="text-3xl md:text-4xl font-bold text-white mb-2">0</p>
              <p className="text-sm text-gray-500">Happy Artists</p>
            </div>
            <div className="text-center">
          ...
          <div ref={section1Ref} className="grid lg:grid-cols-2 gap-16 items-center mb-32">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                Premium Quality,
                <br />
                <span className="text-matrix-green/90">Every Single Time</span>
              </h2>
              <p className="text-lg text-gray-400 mb-8 leading-relaxed font-light">
                Every beat on Isma Files is professionally produced and mastered. We provide MP3, WAV, and Stems formats—giving you complete creative control over your sound.
              </p>
              <ul className="space-y-4">
                {[
                  'Studio-quality production',
                  'Multiple format options (MP3, WAV, Stems)',
          ...
          <div ref={section2Ref} className="grid lg:grid-cols-2 gap-16 items-center mb-32">
            ...
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                Crystal Clear
                <br />
                <span className="text-matrix-green/90">Licensing</span>
              </h2>
              <p className="text-lg text-gray-400 mb-8 leading-relaxed font-light">
                No confusion, no hidden terms. Choose the license that fits your project—from Basic to Exclusive—with a clear PDF contract included with every purchase.
              </p>
              <ul className="space-y-4">
                {[
                  'Transparent pricing structure',
                  'Instant PDF license contract',
                  'Multiple tiers (Basic to Exclusive)',
          ...
          <div ref={section3Ref} className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 lg:order-2">
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                Instant Download,
                <br />
                <span className="text-matrix-green/90">Zero Wait</span>
              </h2>
              <p className="text-lg text-gray-400 mb-8 leading-relaxed font-light">
                Purchase and download your beats immediately. No waiting, no delays. Get your files and license contract in seconds—start creating right away.
              </p>
              <ul className="space-y-4">
                {[
      ...
      <section className="py-32 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl text-gray-400 mb-12 max-w-2xl mx-auto font-light">
            Browse our complete catalog of premium beats. Find your sound, choose your license, and start creating today.
          </p>
